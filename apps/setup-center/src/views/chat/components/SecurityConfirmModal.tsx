...
// C9a §2: ApprovalClass → 中文 + 颜色（必须与 src/synapse/core/policy_v2/enums.py
...
// src/synapse/core/policy_v2/enums.py 的 DecisionAction StrEnum 对齐）。
...
// 后端真相来源: src/synapse/core/policy_v2/engine.py 各 DecisionStep
// 的 name= 参数。
