...
| `node_overrides[].node_intent` | `NODE_INTENT` / `ROOM_INTENT`（相同） | **会议目标**，不可留空 | Manifest `NODE_INTENTS` |
...
| 2026-05-20 | **节点 enabled 开关 + ROOM_INTENT/NODE_INTENT**：§14.5.2.1；`rd_meeting/intents.py`、编排跳过链、配置抽屉开关与主旨编辑。 |
