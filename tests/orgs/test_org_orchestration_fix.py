...
from synapse.orgs.failure_diagnoser import _extract_evidence
from synapse.orgs.models import MsgType, OrgMessage, OrgProject, ProjectTask, TaskStatus
...
class TestSubmitChainOverride:
    ...
    async def test_submit_overrides_wrong_chain_id_from_llm(
        ...
        with caplog.at_level("WARNING", logger="synapse.orgs.tool_handler"):
