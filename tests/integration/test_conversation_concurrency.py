...
from synapse import config as config_mod
from synapse.api.routes.conversation_lifecycle import (
    BusyInfo,
    ConversationLifecycleManager,
    StartResult,
)
from synapse.api.routes.double_texting import DoubleTextingPolicy, resolve_policy
from synapse.api.routes.turn_registry import TurnRegistry
from synapse.core import conversation_metrics as metrics
from synapse.core.agent import Agent
from synapse.core.agent_state import AgentState, TaskState, TaskStatus
from synapse.sessions.session import SessionContext
...
class TestSSEDeltaCoalescer:
    ...
    def test_size_threshold_flushes_immediately(self) -> None:
        from synapse.core.sse_throttle import DeltaCoalescer
    ...
    def test_chain_text_is_coalesced(self) -> None:
        from synapse.core.sse_throttle import COALESCED_TYPES, DeltaCoalescer
