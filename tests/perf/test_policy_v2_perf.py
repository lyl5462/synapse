...
from synapse.core.policy_v2.classifier import ApprovalClassifier
from synapse.core.policy_v2.context import PolicyContext
from synapse.core.policy_v2.engine import PolicyEngineV2
from synapse.core.policy_v2.enums import ConfirmationMode, SessionRole
from synapse.core.policy_v2.models import ToolCallEvent
from synapse.core.policy_v2.schema import PolicyConfigV2
from synapse.core.policy_v2.shell_risk import classify_shell_command
...
class TestAuditWriterSlo:
    ...
    async def test_100_record_batch_flush_p95(self, tmp_path: Path) -> None:
        ...
        from synapse.core.policy_v2.audit_chain import reset_writers_for_testing
