...
from synapse.core.policy_v2.prompt_hardening import (
...
def test_safety_section_contains_hardening_rules():
    ...
    from synapse.prompt import builder
...
def test_tool_summary_replay_path_wraps_content():
    ...
    glue.
    """
    from synapse.core import agent as _agent_mod
    from synapse.core.policy_v2 import prompt_hardening
