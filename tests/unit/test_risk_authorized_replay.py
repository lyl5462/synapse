...
from synapse.core.agent import _consume_risk_authorization
...
async def test_pending_risk_confirm_with_no_action_returns_authorized_replay():
    ...
    from synapse.api.routes import chat as chat_mod
    from synapse.core.confirmation_state import get_confirmation_store
...
def test_format_controlled_action_result_neutral_on_error():
    ...
    from synapse.api.routes import chat as chat_mod
    from synapse.core.confirmation_state import ConfirmationDecision
