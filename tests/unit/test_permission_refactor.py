...
历史背景：
- C6 之前 mock 点是 ``synapse.core.policy.get_policy_engine``，决策走 v1 PolicyEngine。
- C6 之后 mock 点切换到 ``synapse.core.policy_v2.global_engine.get_engine_v2``
...
from synapse.core import reasoning_engine as reasoning_engine_module
...
def _patch_engine_to_raise(monkeypatch: pytest.MonkeyPatch, exc: Exception) -> None:
    ...
    monkeypatch.setattr(
        "synapse.core.policy_v2.adapter._get_engine",
        _boom,
    )
