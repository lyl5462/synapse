...
from synapse.skills.catalog import SKILL_INSTRUCTION_ADVISORY, SkillCatalog
...
async def test_prompt_assembler_passes_intent_tool_hints(monkeypatch):
    ...
    monkeypatch.setattr("synapse.prompt.builder.build_system_prompt", fake_build_system_prompt)
