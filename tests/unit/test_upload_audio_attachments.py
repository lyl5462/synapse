...
from synapse.api.routes import upload
from synapse.core.agent import _format_desktop_attachment_reference
...
def test_audio_upload_uses_relaxed_audio_limit(tmp_path, monkeypatch):
    monkeypatch.setenv("SYNAPSE_MAX_UPLOAD_MB", "0.000001")
    monkeypatch.setenv("SYNAPSE_MAX_AUDIO_UPLOAD_MB", "1")
