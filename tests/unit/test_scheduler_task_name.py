...
def test_scheduler_add_task_rejects_invalid_name():
    ...
    bad = ScheduledTask.create(
        name="../escape",
        task_type=__import__("synapse.scheduler.task", fromlist=["TaskType"]).TaskType.REMINDER,
        trigger_type=__import__("synapse.scheduler.task", fromlist=["TriggerType"]).TriggerType.ONCE,
