...
from synapse.llm.types import LOCAL_ENDPOINT_DEFAULT_CONTEXT_WINDOW, EndpointConfig
from synapse.tools.handlers.config import ConfigHandler
...
def test_brain_tool_schema_budget_scales_down_for_small_context(monkeypatch):
    ...
    monkeypatch.setattr("synapse.core.brain.settings.api_tools_schema_budget_tokens", 12000)
