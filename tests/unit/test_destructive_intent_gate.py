...
from synapse.core.agent import _build_destructive_intent_question, _classify_risk_intent
...
from synapse.core.working_facts import extract_working_facts, format_working_facts
...
def test_task_delivered_message_skips_risk_gate():
    ...
    msg = (
        ...
        "## 交付文件\n"
        "- `synapse-seo-plan.md` - 完整 SEO 优化建议文档（含执行时间线和关键指标监控）\n"
        "## 建议后续行动\n"
