...
from synapse.llm.registries.openrouter import OpenRouterRegistry
from synapse.setup_center.bridge import _list_models_openai
...
async def test_openrouter_registry_falls_back_to_router_models(monkeypatch):
    ...
    monkeypatch.setattr(
        "synapse.llm.registries.openrouter.create_registry_client",
