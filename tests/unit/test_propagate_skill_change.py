...
def patched_env(monkeypatch, tmp_path):
    ...
    monkeypatch.setattr(
        "synapse.skills.watcher.clear_all_skill_caches", clear_caches_mock
    )
    monkeypatch.setattr(
        "synapse.skills.allowlist_io.read_allowlist", read_allowlist_mock
    )
    monkeypatch.setattr(
    ...
    monkeypatch.setattr(
        "synapse.core.agent.Agent.notify_pools_skills_changed",
        staticmethod(notify_pools_mock),
    )
    monkeypatch.setattr(
        "synapse.skills.events.notify_skills_changed", notify_changed_mock
    )
