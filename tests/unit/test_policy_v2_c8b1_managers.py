...
from synapse.core.policy_v2.enums import DecisionSource
...
class TestC8b1PreviewIsolation:
    ...
    def test_make_preview_engine_separate_user_allowlist(self) -> None:
        from synapse.core.policy_v2 import make_preview_engine
        ...
        from synapse.core.policy_v2 import get_config_v2
