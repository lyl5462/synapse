...
from synapse.core.policy_v2.shell_risk import (
...
class TestSubsystemsReadV2Config:
    ...
    def _install_v2_config(cfg) -> None:
        ...
        from synapse.core.policy_v2.engine import build_engine_from_config
        from synapse.core.policy_v2.global_engine import set_engine_v2
    ...
    def test_audit_logger_reads_v2_audit_config(self, tmp_path) -> None:
        ...
        from synapse.core.audit_logger import reset_audit_logger
        from synapse.core.policy_v2.global_engine import reset_engine_v2
        from synapse.core.policy_v2.schema import AuditConfig, PolicyConfigV2
    ...
    def test_checkpoint_manager_reads_v2_checkpoint_config(self, tmp_path) -> None:
        from synapse.core.policy_v2.global_engine import reset_engine_v2
        from synapse.core.policy_v2.schema import CheckpointConfig, PolicyConfigV2
        ...
        import synapse.core.checkpoint as ck_mod
...
class TestConfigPyDoesNotImportV1Internals:
    ...
    def test_no_default_paths_import(self) -> None:
        ...
        path = Path(__file__).parent.parent.parent / "src" / "synapse" / "api" / "routes" / "config.py"
