from synapse.core.agent import (
...
from synapse.prompt.builder import PromptMode, PromptProfile, build_system_prompt
...
suggest_plan: false
""",
        "https://github.com/synapse/synapse/issues/532 帮我分析这个 issue 当前是否仍存在",
    )
...
def test_make_a_plan_request_is_treated_as_external_tool_task():
    assert _looks_like_external_tool_request("帮我做一份 Synapse 的宣传计划") is True
