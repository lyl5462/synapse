...
from synapse.core.policy_v2 import PolicyContext
from synapse.core.policy_v2.adapter import build_policy_context
from synapse.core.reasoning_engine import _compute_confirm_dedup_key
from synapse.core.ui_confirm_bus import UIConfirmBus
...
def test_build_policy_context_child_session_role_honors_caller_mode() -> None:
    ...
    决策，是真 bug。
    """
    from synapse.core.policy_v2 import SessionRole
...
def test_tool_executor_security_confirm_marker_has_no_c13_fields() -> None:
    ...
    import synapse.core.tool_executor as te
