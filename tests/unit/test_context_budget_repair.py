...
from synapse.core.loop_budget_guard import LoopBudgetGuard
from synapse.core.microcompact import microcompact
from synapse.core.reasoning_engine import ReasoningEngine
from synapse.prompt.builder import _build_catalogs_section
...
def test_token_anomaly_compaction_uses_configured_summary_chars(monkeypatch):
    monkeypatch.setattr("synapse.core.reasoning_engine.settings.context_token_anomaly_threshold", 100)
    monkeypatch.setattr("synapse.core.reasoning_engine.settings.context_cached_summary_chars", 100)
