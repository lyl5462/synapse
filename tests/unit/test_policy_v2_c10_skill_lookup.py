...
from synapse.core.policy_v2.enums import ApprovalClass, DecisionSource
from synapse.skills.parser import SkillParser
from synapse.skills.registry import SkillRegistry
...
class TestApprovalClassParsing:
    ...
    def test_risk_class_alias_warns_but_parses(self, tmp_skills_dir, caplog):
        ...
        with caplog.at_level("WARNING", logger="synapse.skills.parser"):
            parsed = SkillParser().parse_file(path)
