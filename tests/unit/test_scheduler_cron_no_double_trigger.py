...
from synapse.scheduler.task import ScheduledTask, TaskStatus, TriggerType
from synapse.scheduler.triggers import CronTrigger
...
async def test_execute_task_success_path_does_not_reschedule_in_current_window(tmp_path: Path):
    ...
    # to the real class.
    with patch("synapse.scheduler.scheduler.datetime", wraps=datetime) as mock_dt:
